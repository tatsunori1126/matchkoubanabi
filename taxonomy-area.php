...
<main class="l-main p-main">
    <div class="c-page__section-title-wrapper">
        <h1 class="c-page__section-title">
            地域別企業一覧：<?php single_term_title(); ?>
        </h1>
    </div>
        ...
        <div class="c-inner">
            <div class="p-company__container">
                <?php
                    ...
                    $term = get_queried_object(); // 現在のターム情報を取得
                    $args = array(
                        'post_type' => 'company',
                        'posts_per_page' => 12,
                        'paged' => $paged,
                        'tax_query' => array(
                            array(
                                ...
                                'field' => 'slug',
                                'terms' => $term->slug,
                                'include_children' => true, // ←★ 子タームも含める！
                            ),
                        ),
                    );
                ...
                <?php if ( $the_query->have_posts() ) : ?>
                    ...
                    <?php endwhile; ?>
                <?php else : ?>
                    <p class="m-none-post-text">この地域の登録企業はまだありません。</p>
                <?php endif; ?>
