...
<main class="l-main p-main">
    <?php $term = get_queried_object(); // 現在表示している業種タームを取得 ?>
    <div class="c-page__section-title-wrapper">
        <h1 class="c-page__section-title"><?php echo esc_html($term->name); ?>の企業一覧</h1>
    </div>
    ...
    <div class="p-company">
        <div class="c-inner">
            ...
            <div class="p-company__filter-toggle">
                <a href="<?php echo get_post_type_archive_link('company'); ?>" id="js-filter-all-btn" class="p-company__filter-toggle-btn">全て</a>
                <button id="js-filter-toggle-btn" class="p-company__filter-toggle-btn active">地域・業種から選ぶ</button>
            </div>
